...
class ApplicationDecisionReason
{
    ...
    private const OPTIONS = [
        ...
        'passed_prescreening' => 'Passed pre-screening',
        'formal_application_completed' => 'Formal application completed',
        'formal_application_not_completed' => 'Formal application not completed',
