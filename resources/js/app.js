...
const pages = {
    ...
    providerProgramEditDirectory: () => import('./pages/ProviderProgramEditDirectoryPage.vue'),
    providerProgramManageDirectory: () => import('./pages/ProviderProgramManageDirectoryPage.vue'),
    providerProgramWorkspace: () => import('./pages/ProviderProgramWorkspacePage.vue'),
    providerProgramMonitoring: () => import('./pages/ProviderProgramMonitoringPage.vue'),
