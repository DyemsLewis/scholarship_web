...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedScholarships(User $tulayAral, User $bukasKinabukasan): void
    {
        ...
        $common = [
            ...
            'support_ends_at' => $deadline->copy()->addYear()->month(6)->day(30)->toDateString(),
            'handoff_mode' => 'onsite',
        ...
        $programs = [
            [
                ...
                'data' => [
                    ...
                    'provider_objectives' => ['education_access', 'community_development', 'equity_inclusion'],
                    ...
                    'eligibility' => 'Currently enrolled senior high school learner with a general average of at least 80% and a household income within the listed bracket.',
            ...
            [
                ...
                'data' => [
                    ...
                    'provider_objectives' => ['education_access', 'community_development', 'equity_inclusion'],
                    'provider_objective_notes' => 'The program helps qualified learners continue their education while strengthening educational participation in the communities served by the foundation.',
                    'eligibility' => 'Incoming first-year college learner with proof of admission, a general average of at least 85%, and availability for a short finalist interview.',
                    'eligible_education_levels' => "senior_high_school\ncollege",
            ...
            [
                ...
                'data' => [
                    ...
                    'eligibility' => 'Currently enrolled elementary or junior high school learner whose parent or guardian can complete the application.',
            ...
            [
                ...
                'data' => [
                    ...
                    'provider_objectives' => ['education_access', 'priority_skills', 'future_talent', 'academic_excellence'],
                    ...
                    'eligibility' => 'Grade 11 or Grade 12 STEM learner with at least an 85% general average and availability for a qualifying exam and finalist interview.',
